...
#> 
   ...
   Write-Host "Creating the AAD application (Web-App-ASPNET)"
   # create the application 
   $webAppAadApplication = New-AzureADApplication -DisplayName "Web-App-ASPNET" `
                                                  -HomePage "https://localhost:44347/" `
                                                  -LogoutUrl "https://localhost:44347/signout-oidc" `
                                                  -ReplyUrls "https://localhost:44347/" `
                                                  -IdentifierUris "https://$tenantName/Web-App-ASPNET" `
                                                  -PublicClient $False
   ...
   Write-Host "Done creating the webApp application (Web-App-ASPNET)"
   ...
   Add-Content -Value "<tr><td>webApp</td><td>$currentAppId</td><td><a href='$webAppPortalUrl'>Web-App-ASPNET</a></td></tr>" -Path createdApps.html
   ...
   $configFile = $pwd.Path + "\..\Web.config"
